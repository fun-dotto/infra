resource "google_cloud_run_v2_job" "build_class_change_notifications" {
  launch_stage = "GA"
  location     = "asia-northeast1"
  name         = "build-class-change-notifications"
...
# terraform import google_cloud_run_v2_job.build_class_change_notifications projects/swift2023groupc/locations/asia-northeast1/jobs/build-class-change-notifications
