  ...
  template {
    containers {
      env {
        ...
        value = "https://academic-api-stg-107577467292.asia-northeast1.run.app"
      }

      env {
        name  = "ANNOUNCEMENT_API_URL"
        value = "https://announcement-api-stg-107577467292.asia-northeast1.run.app"
      }

      env {
        name  = "FUNCH_API_URL"
        value = "https://funch-api-stg-107577467292.asia-northeast1.run.app"
      }

      env {
        name  = "USER_API_URL"
        value = "https://user-api-stg-107577467292.asia-northeast1.run.app"
      }
