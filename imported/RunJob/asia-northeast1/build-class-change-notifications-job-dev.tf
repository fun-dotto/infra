...
# terraform import google_cloud_run_v2_job.build_class_change_notifications_job_dev projects/swift2023groupc/locations/asia-northeast1/jobs/build-class-change-notifications-job-dev
